...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/estadisticas", label: "Estadísticas", icon: "📈", roles: ["admin"], alias: ["stats", "crecimiento", "cohortes", "tendencias", "colocacion", "distribucion", "comportamiento", "metricas"] },
