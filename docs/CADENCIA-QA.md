...
| **Cada hora en jornada** | Respaldo incremental del libro (RPO intradía sin PITR, decisión 15-08). | `node --env-file=.env.local scripts/respaldo-libro.mjs` (Task Scheduler) | Carlos (programarlo una vez) |
